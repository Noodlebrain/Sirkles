...
#reader(lib "htdp-advanced-reader.ss" "lang")((modname Sirkles_old_02) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #t #t none #f () #f)))
...
;Canvas x and y
(define length1 1024)
(define height1 786);SHOULD BE 768
...
;Song
(define song (rs-read "beatmaps/Dimension - Children (Rollz Remix).wav"))
